...
Work by Mirtha Dermisache (1970s). Dermisache composed books, letters, and newspapers with entirely unreadable script. She shows how page layout, paragraph blocks, and line cadence alone can trigger the *experience* of reading:

![mirtha_dermisache-1970s](img/mirtha_dermisache-1970s.jpg)

This is research by S.E. Petersen (1995), showing activation of the cortex by “word-like stimuli” including what she called “false fonts”, or letters from an imaginary alphabet. Neuroscience finds that letter-like shapes can activate reading areas even when they’re not real letters. For us, this suggests a design space of “glyph statistics” (junctions, curvature, spacing) that evoke literacy without language:

![se_petersen_1995_tweal](img/se_petersen_1995_tweal.jpg)

Two engineered scripts: one rationalizing letters by mouth shapes, the other a community-building phonetic system. Writing systems are designed artifacts with social, cognitive, and aesthetic goals.
...
[Hélène Smith](http://www.cabinetmagazine.org/issues/1/i_martian.php)’s “Martian”. Spiritualist automatic writing presented as an extraterrestrial language. A case study in how conviction, repetition, and script-like structure can create the feeling of language — a fluent, internally consistent pseudo-script.

![helene_smith.gif](img/helene_smith.gif)

Paul Klee, *Frontière* (1938). Klee treats line as a thinking tool between drawing and writing. His marks behave like signs that almost cohere into an alphabet—useful inspiration for evolving a minimal mark vocabulary in code.

![klee_frontiere](img/klee_frontiere.jpg)

Miró’s pseudo-calligraphy turns paint into script-like signals; Munari invents “illegible writings” with internal rules. Together they model a path: define constraints first, then let gesture and variation play inside them.
...
Munari argues that legibility is culturally constructed and rule-bound. The invitation is clear: invent new rule sets—directionality, stroke order, grouping—and see what “legible” means to a new audience.
...
A universe of invented signs wrapped in the authority of prints and plates. Max Ernst exploits the aesthetics of cataloging and astronomy to make nonsense feel documentarian.

![max_ernst_cri_000000340314](img/max_ernst_cri_000000340314.jpg)

Luigi Seraphini, *Codex Seraphinianus* (1981). An encyclopedic world with a script that looks systematized but defies decoding. Page design, diagrams, and consistent glyph morphologies create plausibility.
...
Xu Bing, *A Book from the Sky* (1987-1991). Thousands of plausible but unreadable “characters,” carved and printed like classical texts. Authority of material and layout makes viewers work to read—an archetype for generative fake-scripts and page systems.
...
Roman Verostko, an early algorithmic artist, active in computer art since the early 1970s. Code-based procedures drive pen and brush to produce calligraphic swarms. Verostko bridges algorithm and gesture.
...
A neural net trained on kanji generates novel, kanji-like glyphs. It’s a machine hallucination of writing statistics—great for thinking about data, priors, and how far plausibility can go without meaning.
...
Asemic writing operates in the pre-semantic layer of writing: the cues that tell our eyes “this is text” before any decoding—stroke order, baseline, x-height, ligatures, line justification, paragraphing, repetition, and material authority (ink, paper, typesetting). Artists and systems designers exploit those cues to evoke reading without language. For computational practice, the key is to define a rule system (gesture grammar, page grammar, stroke physics) and then let controlled variation generate an evolving “script.”
