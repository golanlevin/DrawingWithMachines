...
// This design is horizontal/landscape (36x24, Architecture-D Format).
...
function draw(){
  background(255); 
  if (bDoExportSvg){
    beginRecordSVG(this, "hp7596_36x24_lissajous.svg");
  }
  ...
  rect(2*inch,2*inch, 32*inch,20*inch); 
...
Once this profile is installed, generate HPGL from SVG using the command (note --landscape): 
