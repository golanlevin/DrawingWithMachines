...
model = 3               # AxiDraw Model (1-4)
                            # 1: AxiDraw V2 or V3 (Default)
                            # 2: AxiDraw V3/A3 or SE/A3
                            # 3: AxiDraw SE/A1 (replaces standard V3 XLX option)
                            # 4: AxiDraw MiniKit
...
x_travel_V3XLX = 34.02    # AxiDraw SE/A1: X Carriage travel in inches.                 Default: 864 mm = about 34.02 inches
y_travel_V3XLX = 23.39    # AxiDraw SE/A1: Y Carriage travel in inches.                 Default: 594 mm = about 23.39 inches
